---
title: "Database Logic Configuration"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{db_logic_config}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This package provides database logic capabilities with flexible types and dependency chain support.

The package supports three main types of database logic configurations:
...
All types include automatic saving to the survey database and error handling. The database logic configuration is specified through the `db_logic` parameter in `survey()`. It accepts a list of configuration objects.
